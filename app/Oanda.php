...
class Oanda {
    ...
    // Constructor
    public function __construct($access_token, $accountID = '') {
        try {
            $this->base_url = 'https://api-fxpractice.oanda.com';
    ...
    public function getPrice($inst) {
        $endPoint = "/v3/accounts/".$this->accountID.'/pricing?instruments='.$inst;
        $fullUrl = $this->base_url . $endPoint;
        $result = $this->makeCall("GET", $this->headers, $fullUrl);
