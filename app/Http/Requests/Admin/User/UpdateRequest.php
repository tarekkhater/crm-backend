...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'address' => ['sometimes','string',new NoHtmlInjection],
            'permanent_address' => ['sometimes', 'nullable', 'string', new NoHtmlInjection],
            // 'currency'=> ['sometimes', 'string',new NoHtmlInjection],
            'postal' => ['sometimes','numeric',new NoHtmlInjection],
        ];
    }
