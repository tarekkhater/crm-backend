...
@section('content')
  ...
  <style>
    ...
    <trade_station :can_trade="{{ setting('can_trade', true) }}" :trades='@json($trades)'
        ...
        <div>
            <div class="container-fluid" style="paddin: 0;padding-top: 22px">
                            ...
                            <div class="card-body" style="padding : 5px!important">
                                <div class="mt-5">
                                    <ul class="nav nav-tabs w-100">
                                        <li class="nav-item w-50 text-center button-30">
                                        ...
                                        <div id="buy-content" class="tab-pane fade in active">
                                            ...
                                            <div class="  mb-3">
                                                <div class="d-flex justify-content-between"
                                                    ...
                                                    <div style="margin-top: -7px;"
                                                        class="d-flex align-content-center align-self-center tg-list-item text-center switch">
                                                        <input v-model="is_take_profit" class="tgl tgl-ios" type="checkbox"
                                                            id="toggle-profit" />
                                                        <label for="toggle-profit" class="ml-2 tgl-btn"
                                                            style="width: 52px; height: 25px;"></label>
                                                    </div>
                                                    <div>
                                            ...
                                            <div class="   mb-2">
                                                <div class="d-flex justify-content-between"
                                                    ...
                                                    <div style="margin-top: -7px;"
                                                        class="d-flex align-content-center align-self-center tg-list-item text-center switch">
                                                        <input v-model="is_stop_loss" class="tgl tgl-ios" type="checkbox"
                                                            id="toggle-loss" />
                                                        <label for="toggle-loss" class="ml-2 tgl-btn"
                                                            style="width: 52px; height: 25px;"></label>
                                                    </div>
                                                    <div>
                                            ...
                                            <div @click="can_trade ? '' : canNotTrade()"
                                                class="d-flex flex-column button-30 ml-auto justify-content-end">
                                                @php
                                                    // 2.30 pm : 9:30 pm
                                                    $openArray = json_decode($currency->open_at, true);
                                                    if (isset($openArray)) {
                                                        if ($currency->open_at) {
                                                            foreach ($openArray as $array) {
                                                               ...
                                                               // $end = '19:00:00';
                                                                ...
                                                                $start = \Carbon\carbon::createFromTimeString($start);

                                                                $end = \Carbon\carbon::createFromTimeString($end);

                                                                $now = \Carbon\carbon::now();

                                                               // dd($now);

                                                                $dayToday = \Carbon\carbon::parse($now)->format('l');

                                                                $daysArray = json_decode($currency->days, true);

                                                                //dd($daysArray);

                                                                $InDays = in_array($dayToday, $daysArray);

                                                                if ($now->between($start, $end) && $InDays) {
                                                                    $between = 1;
                                                                    break;
                                                                }
                                                            }
                                                        ...
                                                        if ($currency->open_at) {
                                                            $start = \Carbon\carbon::createFromTimeString($currency->open_at);

                                                            $end = \Carbon\carbon::createFromTimeString($currency->close_at);
                                                            $now = \Carbon\carbon::now();
                                                ...
                                                @if ((setting('can_trade', true) && (isset($between) && $between == 1)) || auth()->user()->allow_trade == 1)
                                                ...
                                                @else
                                                    <a onclick="notTrade_create()" href="javascript:void()"
                                                        class="btn custom_disabled d-flex"
                                                        style="background-color: #00D589; padding:9px 85px; font-size: 12px;">
                                                        <svg id="Capa_1" enable-background="new 0 0 512 512"
                                                            height="25" viewBox="0 0 512 512" width="25"
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            style="fill: white; margin-bottom: 5px;margin-top: 11px">
                                                            <g>
                                                                <path
                                                                    d="m512 482h-30v-302h-91v302h-30v-182h-90v182h-30v-242h-90v242h-30v-152h-91v152h-30v30h512z">
                                                                </path>
                                        ...
                                        <div>
                                            ...
                                            <div @click="can_trade ? '' : canNotTrade()"
                                                ...
                                                @else
                                                    <hr />
                                                    <a onclick="notTrade_create()" href="javascript:void()"
                                                        class="btn btn-danger d-inline custom_disabled d-flex"
                                                        style="padding:9px 85px; font-size: 12px;">
                                                        <svg id="Capa_1" enable-background="new 0 0 512 512"
                                                            height="25" viewBox="0 0 512 512" width="25"
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            style="fill: white; margin-bottom: 5px;margin-top: 11px">
...
<script>
    ...
    $.ajaxSetup({
     ...
     function notTrade_create(){
         swal("Opps!", "You Can not trade now {{$currency['name']}}", "error");
     }
