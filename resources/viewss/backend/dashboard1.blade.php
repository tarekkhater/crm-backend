...
<!-- Mirrored from html.designstream.co.in/pollo/ltr/page-pricing.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Jun 2021 22:36:10 GMT -->
<head>
    <meta charset="UTF-8">
        ...
        <li class="dropdown active"><a href="#"><i class="icon-book-open"></i>Pages</a>
            <div>
                <ul>
                    ...
                    <li class="active"><a href="page-pricing.html"><i class="icon-wallet"></i> Pricing</a></li>
                        ...
                        <div class="row justify-content-md-center">
                            <div class="col-12 col-md-4 col-xl-3 mb-4 mb-lg-0">
                                <div class="price-table border rounded  text-center  p-3">
                                    <h2 class="font-weight-bold">Standard  Plan </h2>
                            ...
                            <div class="col-12 col-md-4 col-xl-3 mb-4 mb-lg-0">
                                <div class="price-table bg-primary rounded text-white text-center  p-3">
                                    <h2 class="font-weight-bold">Premium Plan </h2>
                            ...
                            <div class="col-12 col-md-4 col-xl-3">
                                <div class="price-table border rounded  text-center  p-3">
                                    <h2 class="font-weight-bold">Business  Plan </h2>
