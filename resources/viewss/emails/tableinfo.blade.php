    ...
    <div>
        <div class="py-4">
                    ...
                    <tbody>
                        <tr>
                            <td class="w-1/2 align-top">
                                <div class="d-flex text-sm text-neutral-600">
                                   <p class="font-bold pr-4">AC/NO: {{$result['id']}}</p>
                                    <p class="font-bold pr-4">NAME: {{$result['name']}}</p>
                                    <p class="font-bold pr-4">SURNAME: {{$result['surname']}}</p>
                                    <p class="font-bold pr-4">CURRENCY: {{$result['currency']}}</p>
                                    <p class="font-bold pr-4">COUNTRY: {{$result['country']}}</p>
                                    <p class="font-bold pr-5">PHONE: {{$result['phone']}}</p>
            ...
            <div class="px-14 text-sm text-neutral-700">
                <p class="text-main font-bold">Best Regards</p>
                <p>Accounts Department</p>
            </div>

            <div class="px-14 py-10 text-sm text-neutral-700">
                <p class="text-main font-bold">Notes</p>
                <h4 class="text-main font-bold" style="text-align:center">Please report to us within 24 hours if this statement is incorrect.
                <br>
Otherwise this statements will be considered to be confirmed by you.</h4>
                <p class="" style="text-align:center">
RISK WARNING: CFDs are leveraged products. Trading in CFDs carries a high level of risk thus may not be appropriate for all investors.
<br>
The investment value can be increased or decreased and the investors may lose their invested capital.
<br>
The Company has no liability to any person or entity for any loss or damage in whole or part caused by, resulting from, or relating to,
any transactions related to CFDs.</p>
                </dvi>

                <footer class="fixed bottom-0 left-0 bg-slate-100 w-full text-neutral-600 text-center text-xs py-3">
                    Supplier Company
                    <span class="text-slate-300 px-2">|</span>
                    info@best-brokersolutions.com
                    <span class="text-slate-300 px-2">|</span>
                    +1-202-555-0106
                </footer>
            </div>
