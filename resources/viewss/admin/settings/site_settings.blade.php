...
{{--            <span class="breadcrumb-item active">Settings Layouts</span>--}}
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Site Settings</h4>
    </div>
        ...
        <div class="br-pagebody">
            <div class="br-section-wrapper">
                ...
                <form action="{{ route('admin.settings.store') }}" method="POST">
                    ...
                    <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Site Settings</h6>
                    ...
                    <table class="table table-bordered display table-condensed responsive nowrap">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                {{-- {{ $key }} --}}
                                    <option {{ setting('user_account') == $plan->id ? 'selected' : '' }} value="{{ $plan->id }}">{{ $plan->name }}</option>
