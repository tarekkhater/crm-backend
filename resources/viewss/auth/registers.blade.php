    ...
    <div class="container-fluid">
        <div class="row mt-0 mr-4">
            <div class="form-group">
                <a href="{{ route('joint.reg') }}" type="submit" class="btn btn-success p-3 float-right">Open Joint Account</a>
            </div>
        </div>
    </div>
    <div class="container">
                    ...
                    <div class="text-wrap p-4 p-lg-5 d-flex img d-flex align-items-ends" style="background-image: url(/auth/images/bg.jpg);">
                        ...
                        <div class="vertical-stepper ">
                            <div class="justify-content-center text-center mt-4 mb-4">
                                ...
                                You are just few simple steps away from placing your first trade
                            </div>
...
{{--                                </div>--}}
                                ...
                                <div class="col-md-12">
                                    <div class="form-group d-flex align-items-center">
                                        ...
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend mx-0">
                                                <select onchange="endpoint('{{ route('get-country-info','') }}',this.value)" name="country" id="country" class="form-control">
                                ...
                                <div class="col-md-12 text-center">
                                    <button type="submit" class="btn btn-secondary submit py-3 px-5 font-weight-bold">Submit</button>
                                </div>
                            </div>
                        </form>
