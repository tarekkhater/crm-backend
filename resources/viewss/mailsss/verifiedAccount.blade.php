...
Email verification code
    ...
    font-weight: 500;" class="text-[#242052CC]">We have received a request to verify your Al-Wa'i Al-Mali account email.<br/> Please use the following code to activate your account:
              </main>
            </section>
          </td>
        </tr>
...
">
    ...
    line-height: 26px;"><b style="font-family: system-ui;color:#037353;">Enter the code </b>Go to the account verification page.
              <br />
              <span style="font-family: system-ui;color:#037353;">https://trade.alwaaialmali.com</span>
            </p>
