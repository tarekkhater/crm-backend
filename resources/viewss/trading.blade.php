...
<html lang="en">
  <head>
    ...
    <script type="module" crossorigin src="{{asset('trading/assets/index-D5h793q_.js')}}"></script>
    <link rel="stylesheet" crossorigin href="{{asset('trading/assets/index-CyE3oWnF.css')}}">
  </head>
