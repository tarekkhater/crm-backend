<div class="sticky">
    ...
    <div class="app-sidebar">
        <div class="side-header">
            <a class="header-brand1" href="index-3.html">
                <img src="{{ setting('favicon','/images/fav.png') }}" class="header-brand-img desktop-logo" alt="logo">
                <img src="{{ setting('favicon','/images/fav.png') }}" class="header-brand-img toggle-logo" alt="logo">
                <img src="{{ setting('favicon','/images/fav.png') }}" class="header-brand-img light-logo" alt="logo">
                <img src="{{ setting('favicon','/images/fav.png') }}" class="header-brand-img light-logo1" alt="logo">
            </a><!-- LOGO -->
        </div>
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{route('admin.overnights')}}" class="slide-item">Overnight</a></li>
