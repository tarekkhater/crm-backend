                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title text-capitalize">Bonus BTC Withdrawal</h4>
                            ...
                            <div class="card-body" id="deposits">
                                <div class="row">
                                    <form method="post" action="{{ route('backend.bonus.withdrawal.store') }}" class="py-5 col-md-6 col-sm-12">

                                        {{ csrf_field() }}

                                        <div class="form-group row align-items-center">
                                            <input type="hidden" name="type" value="bonus_balance" />
                                            <div class="col-sm-4">
