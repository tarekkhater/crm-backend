                ...
                <div class="row mg-t-10">
                    <div class="col-xl-10">
                        ...
                        <div class="form-layout form-layout-4">
                            <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Update Role</h6>
...
{{--                                                                    <br />--}}
                                                                        ...
                                                                        <div class="mb-4" style="margin-bottom: 10px">
                                                                            <div class="switch">
                                                                                <input id="switch-{{$value['id']}}" {{in_array($value->id, $rolePermissions) ? 'checked' : ''}}     value="{{$value['id']}}" name="permission[]" type="checkbox" class="switch-input" />
                                                                                <label for="switch-{{$value['id']}}" class="switch-label">Switch</label>
