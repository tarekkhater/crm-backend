                    ...
                    <div class="row mg-b-25">
                        ...
                        <div class="col-md-3">
                            <div class="form-group mg-b-10-force">
                                ...
                                <input class="form-control" required type="number" name="min_unit" placeholder="Minimum Unit">
                            </div>
                        </div><!-- col-8 -->
                        <div class="col-md-3">
                            <div class="form-group mg-b-10-force">
                                <label class="form-control-label"> Max Unit: <span class="tx-danger">*</span></label>
                                <input class="form-control" required type="number" name="max_unit" placeholder="Maximum Unit">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group mg-b-10-force">
                                <label class="form-control-label"> Price : <span class="tx-danger">*</span></label>
                                <input class="form-control" step="any" required type="number" name="price" placeholder="Price">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group mg-b-10-force">
                                <label class="form-control-label"> Package Color : <span class="tx-danger">*</span></label>
                                <input class="form-control" step="any" required type="color" name="icon" placeholder="Icon">
                            </div>
                        </div>
