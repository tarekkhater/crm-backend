...
{{--            <span class="breadcrumb-item active">Settings Layouts</span>--}}
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Mail Settings <br>
        Make sure smtp is valid before enabling any email
        </h4>
    </div>
            ...
            <div class="br-section-wrapper">
                ...
                <div class="table-wrapper">
                    <table class="table table-bordered display table-condensed responsive nowrap">
                        ...
                        <tr>
                            <td class="text-capitalize">Notify Admin of New User
                            <br />
                                admin_newuser_notify
                            </td>
                            <td>
                                <select required name="admin_newuser_notify" class="form-control">
                                    <option {{ setting('admin_newuser_notify') == 1 ? 'selected' : '' }} value="1">YES</option>
                                    <option {{ setting('admin_newuser_notify') == 0 ? 'selected' : '' }} value="0">No</option>
                                </select>
                            </td>
                        </tr>
