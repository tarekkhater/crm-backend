      ...
      <main style="text-align : start; padding-left : 20px; padding-right : 20px;">
        <div class="my-8 grid grid-cols-1 gap-6">
          ...
          <p style="margin-top : 10px;color:#000;" class="text-[#242052CC]">
            We received a request to Verified your Account for your Paradox Investing account. Please use the following code to Verified your Account:
        ...
        <div class="my-12">
          ...
          <div class="gird gird-cols-1 mt-2">
            ...
            <div class="gap-4 my-6" style="display:inline-flex;margin-top:5px;align-items: baseline;align-items: anchor-center;">
              ...
              <p style="align-content:center!important;color:#000;"><b style="font-family: system-ui;color:{{ config('email-branding.colors.accent') }};">Enter the Code </b>Enter the code provided above.</p>
            </div>
            ...
            <!--  <p style="align-content:center!important;color:#000;"><b style="font-family: system-ui;color:{{ config('email-branding.colors.accent') }};">Create a New Password</b> Follow the instructions to set a new password.</p>-->
            <!--</div>-->
          </div>
        </div>
      </main>
